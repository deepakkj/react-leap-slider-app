  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      props.options.map(function (option) {
        return React.createElement(Option, { optionText: option, key: option, handleDeleteOption: props.handleDeleteOption });
      })
    )
  );
};
...
var IndecisionApp = function (_React$Component2) {
  ...
  function IndecisionApp(props) {
    ...
    _this2.makeDecision = _this2.makeDecision.bind(_this2);
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handleDeleteOption(optionToRemove) {
      // const newOptionsArray = this.state.options;
      // const newOptionIndex = newOptionsArray.indexOf(optionToRemove);
      // if(newOptionIndex > -1) {
      //   newOptionsArray.splice(newOptionIndex, 1);
    ...
    value: function handleAddOption(option) {
      ...
      this.setState(function (prevState) {
        var newOptionArray = prevState.options.concat([option]);
        return {
    ...
    value: function render() {
      return React.createElement(
        'div',
        null,
        React.createElement(Header, { subtitle: 'Put your life in the hands of your computer' }),
